...
"use strict";
module.exports = JSON.parse('{"name":"@truffle/core","description":"Core code for Truffle command line tool","license":"MIT","author":"consensys.net","homepage":"https://github.com/trufflesuite/truffle#readme","repository":{"type":"git","url":"https://github.com/trufflesuite/truffle.git","directory":"packages/core"},"bugs":{"url":"https://github.com/trufflesuite/truffle/issues"},"version":"5.5.24","bin":{"truffle":"./cli.js","truffle-exec":"./exec.js"},"scripts":{"prepare":"exit 0","test":"mocha ./test/** ./test/**/*"},"dependencies":{"@truffle/artifactor":"^4.0.163","@truffle/box":"^2.1.54","@truffle/codec":"^0.13.2","@truffle/compile-common":"^0.7.32","@truffle/compile-solidity":"^6.0.37","@truffle/config":"^1.3.34","@truffle/contract":"^4.5.19","@truffle/dashboard":"^0.1.9","@truffle/debug-utils":"^6.0.29","@truffle/debugger":"^11.0.2","@truffle/decoder":"^5.2.22","@truffle/deployer":"^3.2.90","@truffle/environment":"^0.2.117","@truffle/error":"^0.1.0","@truffle/expect":"^0.1.1","@truffle/fetch-and-compile":"^0.5.12","@truffle/interface-adapter":"^0.5.20","@truffle/migrate":"^3.3.4","@truffle/plugins":"^0.2.7","@truffle/preserve":"^0.2.7","@truffle/promise-tracker":"^0.1.1","@truffle/provider":"^0.2.58","@truffle/provisioner":"^0.2.57","@truffle/require":"^2.1.0","@truffle/resolver":"^9.0.10","@truffle/source-fetcher":"^1.0.13","@truffle/spinners":"^0.2.0","@truffle/workflow-compile":"^4.0.27","address":"^1.1.2","chai":"^4.2.0","colors":"1.4.0","command-exists":"^1.2.8","conf":"^10.0.2","debug":"^4.3.1","del":"^2.2.0","ethereum-cryptography":"1.1.2","ethereumjs-wallet":"^1.0.2","fs-extra":"^9.1.0","ganache":"7.4.0","get-port":"^5.1.1","get-random-values":"^1.2.2","glob":"^7.1.6","inquirer":"8.2.2","js-interpreter":"2.2.0","lodash":"^4.17.21","mocha":"9.2.2","node-emoji":"^1.8.1","original-require":"^1.0.1","sane":"^4.0.2","semver":"7.3.7","source-map-support":"^0.5.19","spawn-args":"0.2.0","tmp":"^0.2.1","universal-analytics":"^0.4.17","web3":"1.7.4","web3-utils":"1.7.4","xregexp":"^4.2.4","yargs":"^13.3.0"},"devDependencies":{"@truffle/blockchain-utils":"^0.1.3","app-module-path":"^2.2.0","chai-as-promised":"^7.1.1","memorystream":"^0.3.1","sinon":"^9.0.2"},"publishConfig":{"access":"public"},"authors":[{"name":"Tim Coulter","email":"tim@trufflesuite.com","url":"https://github.com/tcoulter"}],"namespace":"consensys","gitHead":"bc911496cdb3019a91398199dc9b260c6007df7f"}');
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,4957,325,5136,5674,6674,8516,406,1324,8716,2765,5358,3983,4866,6793,4877,3833,2924,1669,4914,6062,6002,6642,2195,553,4273,4889,3459,458,2422], () => (__webpack_require__(489244)))
